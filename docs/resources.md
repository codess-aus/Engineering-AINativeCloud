---
title: Resources
description: Every external link used across this site, plus further reading on agentic engineering.
---
...
extra starting points if you want to keep exploring agentic engineering, agentic workflows, and platform
engineering for the AI-native era.

## Start here

<p>
  <a class="anc-button" href="https://github.com/github/awesome-copilot" target="_blank" rel="noopener">Awesome GitHub Copilot →</a>
  <a class="anc-button" href="https://github.com/features/copilot" target="_blank" rel="noopener">Agentic workflows on GitHub →</a>
...
- [Using GitHub Copilot code review](https://docs.github.com/copilot/how-tos/copilot-on-github/use-copilot-agents/copilot-code-review)
- [About rulesets](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-repository-rules/about-rulesets)
...
This site accompanies "Engineering the AI-Native Cloud," a DevOps Asia Conference talk on cloud native AI in
